...
Execute unit tests
```
    cd "ControlSystem.WebApi.Disease.AWS/test/ControlSystem.WebApi.Disease.AWS.Tests"
    dotnet test
```

Deploy application
```
    cd "ControlSystem.WebApi.Disease.AWS/src/ControlSystem.WebApi.Disease.AWS"
